    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 transition-colors">
        <div class="flex items-center justify-between mb-4">
          ...
          <span v-if="stats" class="text-sm font-medium text-green-600 dark:text-green-400">+{{ stats.propertiesGrowth }}%</span>
        </div>
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-1">
          <span v-if="loadingStats">...</span>
          <span v-else>{{ stats?.totalProperties || 0 }}</span>
        </h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 transition-colors">
        <div class="flex items-center justify-between mb-4">
          ...
          <span v-if="stats" class="text-sm font-medium text-green-600 dark:text-green-400">+{{ stats.usersGrowth }}%</span>
        </div>
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-1">
          <span v-if="loadingStats">...</span>
          <span v-else>{{ stats?.totalUsers?.toLocaleString() || 0 }}</span>
        </h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 transition-colors">
        <div class="flex items-center justify-between mb-4">
          ...
          <span v-if="stats" class="text-sm font-medium text-green-600 dark:text-green-400">+{{ stats.bookingsGrowth }}%</span>
        </div>
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-1">
          <span v-if="loadingStats">...</span>
          <span v-else>{{ stats?.totalBookings || 0 }}</span>
        </h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">Reservas del Mes</p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 transition-colors">
        <div class="flex items-center justify-between mb-4">
          ...
          <span v-if="stats" class="text-sm font-medium text-green-600 dark:text-green-400">+{{ stats.revenueGrowth }}%</span>
        </div>
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-1">
          <span v-if="loadingStats">...</span>
          <span v-else>${{ stats?.totalRevenue?.toLocaleString() || 0 }}</span>
        </h3>
        <p class="text-sm text-gray-600 dark:text-gray-400">Ingresos del Mes</p>
      </div>
    </div>
