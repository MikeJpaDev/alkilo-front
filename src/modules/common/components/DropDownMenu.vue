<template>
  <div
    class="flex items-center justify-center min-h-screen from-green-100 via-green-300 to-green-500 bg-gradient-to-br"
  >
      ...
      <div class="max-w-md mx-auto space-y-6">
        <div class="dropdown-menu">
          ...
          <div class="bg-white rounded-lg shadow-xl px-4 relative mt-8">
            ...
            <div
              class="py-6 flex items-center w-full hover:bg-gray-50 border-t border-gray-200 hover:bg-gray-50"
            >
              <a href="#" class="flex-1">
